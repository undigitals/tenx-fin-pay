...
export const EditName = ({ closeSheet }: IProps) => {
  ...
  return (
    ...
    >
      <CustomCard padding="0" marginTop={0}>
        ...
        <Form.Item
          label={<CustomRequiredLabel translation="profile." label="Preferred Name" />}
          name="preferredName"
          validateTrigger={['onBlur', 'onChange']}
          rules={[getRequiredRule('profile.Please input your preferred name')]}
        >
